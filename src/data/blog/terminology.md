...
Something like *foo is bound to 10*
```
foo = 10 
```
...
For instance, I almost had tears in my eye when I learned the definition of value:
...
Why is it called a lambda function? frustrated typographers:
...
I loosened up; I stopped correcting people when not necessary. I also noticed I started to dislike courses and books that are full of unimaginative jargon. I also found that I don't care for those "ities" getting thrown everywhere without purpose: "scalability," "extensibility," and even "creativity" sometimes, and so on. I found that some people use them without purpose, even though they might be good words in themselves. I started to prefer simple terms. (and there is a worse kind: inventing terms purely for "prestige." One example I like is "ideation", [which another word for "thinking"](https://web.archive.org/web/20190207015323/https://hbr.org/2008/08/why-jargon-feeds-on-lazy-minds.html).)


I also started to appreciate it in books and in courses when the teacher shows that they are aware of jargon and terms that sound way too fancy.

> The first step is scanning, also known as lexing, or (if you’re trying to impress someone) lexical analysis. They all mean pretty much the same thing. -- Crafting Interpreters

I like it because it sounds human.

## When misusing terms causes misunderstanding

I remembered a professor saying:
> "JavaScript is a interpreted language" -- and started expaining the drawbacks of being interpreted.

Now, later when I studied programming languages, I realized how what he said actually distorted my understanding.
Being interpreted or compiled is not a matter of the language; it's a property of the implementation. Without that understanding, one starts to confuse dynamic typing with interpreting and static typing with compiling.
Misusing terms can actually be a problem. Words and terms are there to build understanding of the world around us; if that understanding is distorted by misusing terms, leading to wrong thinking, perhaps it's worth being careful.
...
As a closing though, I'm currently reading the novel Orwell's 1984, and I found the idea of creating a new language (Newspeak) fascinating: a vocabulary deliberately small to control how people think and feel. So I was thinking, misuse of words, or worse, no words at all, makes sure you never see the flowers.
